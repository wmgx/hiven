...
assert.match(files.surfaceActions, /surface\.kind === ['"]settings['"][\s\S]*requestOpenLauncherHostSurface\(['"]settings['"]\)/, 'Surface focus must route Settings surfaces through the launcher host surface')
assert.match(files.surfaceActions, /surface\.kind === ['"]plugins['"][\s\S]*requestOpenLauncherHostSurface\(['"]plugins['"]\)/, 'Surface focus must route Plugins surfaces through the launcher host surface')
