...
assert(/filterParamOptions\(paramOptions\(param,\s*locale\),\s*frame\.query,\s*locale\)/.test(launcherParamStep), 'LauncherParamStep option filtering should pass locale into the shared matcher')
