...
assert.match(editorBridge, /request = createEditorBridgeRequest[\s\S]*waitForEditorBridgeResponse[\s\S]*persistPendingEditorBridgeRequest\(request\)[\s\S]*showEditorWindow\(\)[\s\S]*waitForEditorBridgeReady/, 'editor bridge must persist startup-sensitive requests before opening the editor window')
