...
assert.match(pluginApiSource, /requestOpenLauncherHostSurface\(['"]plugins['"]\)/, 'plugin launcher API should open Plugins as a launcher-hosted surface')
assert.match(pluginApiSource, /requestOpenLauncherHostSurface\(['"]settings['"]\)/, 'plugin launcher API should open Settings as a launcher-hosted surface')
