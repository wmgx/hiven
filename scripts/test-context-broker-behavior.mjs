...
assert.deepEqual(JSON.parse(JSON.stringify(defaultSnapshot.externalSelection)), { kind: 'text', text: 'selected from browser', preview: 'selected from browser' })
...
assert.deepEqual(defaultCalls.invoke, ['current_foreground_app_context', 'last_foreground_selection_text'])
