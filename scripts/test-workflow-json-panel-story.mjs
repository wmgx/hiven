...
const files = {
  ...
  jsonPlugin: read('src/plugins/json/index.ts'),
  jsonSurface: read('src/plugins/json/JsonSurface.tsx'),
  jsonManifest: read('src/plugins/json/manifest.json'),
...
assert.match(files.jsonManifest, /"ui"/, 'JSON manifest capabilities must include ui')
