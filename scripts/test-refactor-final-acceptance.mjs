...
assert.match(files.pluginSurfaceWindowManager, /showPluginSurfaceWindow/, 'window manager must expose plugin surface open lifecycle')
assert.match(files.pluginSurfaceWindowManager, /hidePluginSurfaceWindow/, 'window manager must expose plugin surface hide lifecycle')
